...
public abstract class AbstractReservationProviderModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.config.reservation_provider.impl.ReservationProviderModuleMXBean,org.opendaylight.controller.config.api.RuntimeBeanRegistratorAwareModule {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.reservation_provider.impl.AbstractReservationProviderModule.class);
    ...
    private final AbstractReservationProviderModule oldModule;
    ...
    public AbstractReservationProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractReservationProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractReservationProviderModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    private org.opendaylight.controller.config.yang.config.reservation_provider.impl.ReservationProviderRuntimeRegistrator rootRuntimeBeanRegistratorWrapper;

    public org.opendaylight.controller.config.yang.config.reservation_provider.impl.ReservationProviderRuntimeRegistrator getRootRuntimeBeanRegistratorWrapper(){
    ...
    public void setRuntimeBeanRegistrator(org.opendaylight.controller.config.api.runtime.RootRuntimeBeanRegistrator rootRuntimeRegistrator){
        this.rootRuntimeBeanRegistratorWrapper = new org.opendaylight.controller.config.yang.config.reservation_provider.impl.ReservationProviderRuntimeRegistrator(rootRuntimeRegistrator);
    }
    ...
    public boolean canReuseInstance(AbstractReservationProviderModule oldModule){
    ...
    public boolean isSame(AbstractReservationProviderModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractReservationProviderModule that = (AbstractReservationProviderModule) o;
