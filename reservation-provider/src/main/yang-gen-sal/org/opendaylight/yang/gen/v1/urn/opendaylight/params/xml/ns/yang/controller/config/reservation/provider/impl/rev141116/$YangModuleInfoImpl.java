...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "reservation-provider-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:reservation-provider:impl";
    private final String revision = "2014-11-16";
    private final String resourcePath = "/META-INF/yang/reservation-provider-impl.yang";
