...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "butler-service-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:butler-service:impl";
    private final String revision = "2014-11-16";
    private final String resourcePath = "/META-INF/yang/butler-service-impl.yang";
