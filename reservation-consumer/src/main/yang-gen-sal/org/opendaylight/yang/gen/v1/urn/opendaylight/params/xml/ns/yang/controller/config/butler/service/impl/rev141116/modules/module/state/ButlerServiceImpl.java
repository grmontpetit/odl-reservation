 ...
 * <i>butler-service-impl/modules/module/state/(urn:opendaylight:params:xml:ns:yang:controller:config:butler-service:impl?revision=2014-11-16)butler-service-impl</i>
 */
public interface ButlerServiceImpl
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.butler.service.impl.rev141116.modules.module.state.ButlerServiceImpl>,
    State
{
