 ...
 * <i>butler-service-impl/butler-service</i>
 */
public abstract class ButlerService extends ServiceType
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:config:butler-service:impl","2014-11-16","butler-service");;
